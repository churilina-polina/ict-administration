...
По политике курса (`AGENTS.md` / `CLAUDE.md`) пользовались AI-ассистентом — для генерации каркаса конфигов и кода сервиса и для пошагового разбора незнакомых компонентов. Устройство каждого элемента стека, назначение файлов, смысл PromQL-выражений и обоснование порогов алертов разбирали отдельно — всё это своими словами изложено в этом отчёте.
